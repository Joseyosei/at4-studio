      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="w-12 h-12 rounded-full bg-charcoal-mid border border-primary/30 flex items-center justify-center text-gold hover:bg-gold hover:text-primary-foreground transition-colors"
